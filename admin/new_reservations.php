...
<head>
    ...
    <title>Admin - New Reservation</title>
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                <h3 class="mb-4">NEW RESERVATION</h3>

                <div class="card border-0 shadow-sm mb-4 ">
                    <div class="card-body">

                        <div class="text-end mb-4">
                            <input type="text" oninput="get_reservations(this.value)" class="form-control shadow-none w-25 ms-auto" placeholder="Type anything to search...">
                        </div>
