                ...
                <form action="rooms.php">
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="form-select shadow-none" name="guest">
                                <?php 
                                    $guests_query = mysqli_query($con,"SELECT MAX(guest) AS `max_guest` FROM `rooms`
                                    WHERE `status`='1' AND `removed`='0'");
                                    $guests_result = mysqli_fetch_assoc($guests_query);

                                    for($i=1;$i<=$guests_result['max_guest']; $i++)
                                    {
                        ...
                        <div class="col-lg-1 mb-lg-3 mt-2">
                            <button type="submit" class="btn text-white shadow-none custom-bg">Check Now</button>
                        </div>
                    </div>
                </form>
            </div>
